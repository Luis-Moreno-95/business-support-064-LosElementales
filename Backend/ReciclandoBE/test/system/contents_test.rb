...
class ContentsTest < ApplicationSystemTestCase
  ...
  test "creating a Content" do
    ...
    fill_in "Descripcion Contenido", with: @content.descripcion_contenido
    fill_in "Nombre Contenido", with: @content.nombre_contenido
    fill_in "Ruta Multimedia Contenido", with: @content.ruta_multimedia_contenido
