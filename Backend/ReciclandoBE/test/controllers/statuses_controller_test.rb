...
class StatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create status" do
    assert_difference('Status.count') do
      post statuses_url, params: { status: { descripcion_estado: @status.descripcion_estado } }
    end
  ...
  test "should update status" do
    patch status_url(@status), params: { status: { descripcion_estado: @status.descripcion_estado } }
