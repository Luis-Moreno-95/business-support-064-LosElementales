...
class ClasificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clasification" do
    assert_difference('Clasification.count') do
      post clasifications_url, params: { clasification: { descripcion_clasificacion: @clasification.descripcion_clasificacion } }
    end
  ...
  test "should update clasification" do
    patch clasification_url(@clasification), params: { clasification: { descripcion_clasificacion: @clasification.descripcion_clasificacion } }
